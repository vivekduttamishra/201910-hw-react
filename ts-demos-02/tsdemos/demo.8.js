...
var GenericSearchEngine = /** @class */ (function () {
    function GenericSearchEngine(records) {
        this.records = records;
    }
    GenericSearchEngine.prototype.search = function (condition, param) {
        var result = [];
...
var se = new GenericSearchEngine(books);
